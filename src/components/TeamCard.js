...
export default function TeamCard({ name, role, degree, image }) {
  return (
    <div>
      <article
        className="flex rounded-xl items-center space-y-3 flex-shrink-0 w-full mt-5 md:mt-10 xl:w-[450px] snap-center p-6 bg-[#1e2320] drop-shadow-[4px_8px_8px_rgba(226,135,67,0.5)] hover:opacity-100 opacity-90 
